...
![](http://www.smallcpp.cn/theme/images/MAVEN/Default阶段.png)
...
![](http://www.smallcpp.cn/theme/images/MAVEN/MAVEN插件设置1.png)

![](http://www.smallcpp.cn/theme/images/MAVEN/MAVEN插件设置2.png)

![](http://www.smallcpp.cn/theme/images/MAVEN/MAVEN插件设置3.png)

我们可以新建 maven 项目, 也可以从现有的 java 项目转换:

从现有项目**转换**:

![](http://www.smallcpp.cn/theme/images/MAVEN/现有项目转换MAVEN.png)

或者**新建** maven 项目:

![](http://www.smallcpp.cn/theme/images/MAVEN/新建MAVEN.png)

![](http://www.smallcpp.cn/theme/images/MAVEN/简单项目.png)

![](http://www.smallcpp.cn/theme/images/MAVEN/创建POM.png)

maven 项目的左上角有个 **m** 标记, 并且项目下有 `pom.xml` 文件:

![](http://www.smallcpp.cn/theme/images/MAVEN/MAVEN项目结构.png)

并且项目右键多了个一些 maven 选项:

![](http://www.smallcpp.cn/theme/images/MAVEN/常用MAVEN菜单.png)

![](http://www.smallcpp.cn/theme/images/MAVEN/MAVENRUNAS.png)

说下 `mvn build` 这个选项, mvn 是没有这个命令的, 这个命令菜单是 Eclipse 提供一个接口, 选择该菜单就能通过配置来执行任意 mvn 命令, 如 `mvn clean install`:

![](http://www.smallcpp.cn/theme/images/MAVEN/RUNCONFIG.png)

如果配置错了, 可以在下面这里进行修改:

![](http://www.smallcpp.cn/theme/images/MAVEN/RUNCONFIG0.png)

![](http://www.smallcpp.cn/theme/images/MAVEN/RUNCONFIG1.png)
...
![](http://www.smallcpp.cn/theme/images/MAVEN/JAR下载.png)

然后就能在 **progress** 视图看到 Eclipse 进行了下载操作:

![](http://www.smallcpp.cn/theme/images/MAVEN/DOWNLOADJAR.png)

或者

![](http://www.smallcpp.cn/theme/images/MAVEN/DOWNLOADJAR1.png)

# 添加依赖
在 Eclipse 中双击打开 `pom.xml` 可以以可视化的方式添加依赖 (也可以在项目右键的 maven 菜单中使用该方式):

![](http://www.smallcpp.cn/theme/images/MAVEN/添加依赖0.png)

打开添加依赖窗口后, 在下图中红框处输入内容可以检索本地仓库, 如果本地仓库没有则检索不到:

![](http://www.smallcpp.cn/theme/images/MAVEN/添加依赖1.png)

检索不到时候就需要手动填写所依赖 jar 包的 maven 特征:

![](http://www.smallcpp.cn/theme/images/MAVEN/添加依赖2.png)
