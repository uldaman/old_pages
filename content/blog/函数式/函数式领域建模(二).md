...
![]({filename}/images/函数式领域建模/communicate.png)
...
![]({filename}/images/函数式领域建模/converted-dto.png)

在下游中, 则是这个过程的逆向: 将 JSON/XML 反序列化为 DTO, 然后将其转换为领域对象.

![]({filename}/images/函数式领域建模/converted-domain.png)
...
![]({filename}/images/函数式领域建模/trust.png)
...
![]({filename}/images/函数式领域建模/context-map2.png)
...
![]({filename}/images/函数式领域建模/workflow.png)
...
![]({filename}/images/函数式领域建模/workflow-diagram.png)
...
![]({filename}/images/函数式领域建模/onion.png)
