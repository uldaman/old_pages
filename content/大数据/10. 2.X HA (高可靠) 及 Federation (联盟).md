...
# HA + Federation 架构图
![](http://blog.smallcpp.cn/theme/images/高可靠联盟/HAFederation.png)
...
![](http://blog.smallcpp.cn/theme/images/Hadoop新特性/HDFS联邦.png)
...
![](http://blog.smallcpp.cn/theme/images/高可靠联盟/ClientSideMountTable.png)
...
## 接管方式
- 手动接管
- 自动接管, 要通过 FailoverController (故障转移控制器) 去实现, 而 FailoverController 是属于 [zookeeper](http://blog.smallcpp.cn/07-zookeeper-jian-jie.html) 集群的一部分.
